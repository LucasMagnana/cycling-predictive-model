...
with open("files/veleval/data_processed/observations_matched_simplified.df", "rb") as infile:
...
if not os.path.exists(os.path.dirname("files/veleval/city_graphs/city.ox")):
    os.makedirs(os.path.dirname("files/veleval/city_graphs/city.ox"))
